...
4. [Дизайнеру](./designer/README.md "Правила для дизайнеров")
...
## JS
    ...
    1. Не используем jquery;
    2. Использовать js библиотеки только те которые есть в npm;
...
Правила написания scss airbnb: [Ссылка](https://github.com/vladislav805/airbnb-css-ru)
    ...
    11. Не допускать моргания фона кнопок, если они сделаны через background-image
***
### BEM:
